"""
instalar.py
Execute este script UMA VEZ dentro de C:\Conciliador com o venv ativo.
Ele reescreve o app.py diretamente, sem depender de download.
...
DESTINO = os.path.join(os.path.dirname(os.path.abspath(__file__)), "app.py")

CONTEUDO = r'''import streamlit as st
import pandas as pd
import numpy as np
...
print(f"✅ app.py reescrito com sucesso em: {DESTINO}")
